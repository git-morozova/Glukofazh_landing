...
const swiper = new Swiper('.slider', {
	...
	allowTouchMove: false, // прокрутка перетаскиванием слайда мышью
	loop: false,
	mousewheel: {
		enabled: true,
		sensitivity: 2.4
...
let renderZeroSlide = () => {	
	document.querySelector(".slide0_layer4__stages").style.cssText = "opacity: 1; z-index: 290;"; // кнопки с этапами
...
let renderFifthSlide = () => {
	...
	document.querySelector(".slide5_layer2__circle-arrow-one").style.cssText = "display: block"; // стрелка в кружке 1
	document.querySelector(".slide5_layer2__circle-arrow-two").style.cssText = "display: block"; // стрелка в кружке 2
...
let renderSixthSlide = () => {
	...
	document.querySelector(".slide6_layer2__circle-arrow-one").style.cssText = "display: block"; // стрелка в кружке 1
	document.querySelector(".slide6_layer2__circle-arrow-two").style.cssText = "display: block"; // стрелка в кружке 2
...
let renderSeventhSlide = () => {
	...
	document.querySelector(".slide7_layer3__nuts").style.cssText = "display: block"; // желуди
...
let renderEigthSlide = () => {
	document.querySelector(".header-button-quiz").style.cssText = "display: block"; // кнопка квиз
...
let fadeZeroSlide = () => {
	document.querySelector(".slide0_layer4__stages").style.cssText = "opacity: 0; z-index: 0;"; // кнопки с этапами
...
let fadeFifthSlide = () => {
	...
	document.querySelector(".slide5_layer2__circle-arrow-one").style.cssText = "display: none"; // стрелка в кружке 1
	document.querySelector(".slide5_layer2__circle-arrow-two").style.cssText = "display: none"; // стрелка в кружке 2
...
let fadeSixthSlide = () => {
	...
	document.querySelector(".slide6_layer2__circle-arrow-one").style.cssText = "display: none"; // стрелка в кружке 1
	document.querySelector(".slide6_layer2__circle-arrow-two").style.cssText = "display: none"; // стрелка в кружке 2
...
let fadeSeventhSlide = () => {
	...
	document.querySelector(".slide7_layer3__nuts").style.cssText = "display: none"; // желуди
...
let fadeEigthSlide = () => {
	...
	document.querySelector(".header-right").style.cssText = "display: none"; // ссылка назад
...
let changeWithDirection = function () {
	...
	if (currentSlide !== "8") {
		document.querySelector(".header-button-quiz").style.cssText = "display: none"; // кнопка квиз
	}	
	if (currentSlide == "2") {
...
window.onload = function () {
	...
	document.querySelector(".swiper-button-next").style.display = 0;
...
let changeStart = function () {
	...
	if (screenWidth <= 1920) { // для экранов менее 1920рх	
		...
		if (swiper.activeIndex == 0) {
			...
			bar.style.transform = "translate3d(250px, 0px, 0px)"
		} else if (swiper.activeIndex == 3) {
...
let toggleArrows = function () {
	...
	if (currentSlide == "0") {		
		...
		document.querySelector(".arrow-prev").style.display = "block";
		document.querySelector(".arrow-prev").style.opacity = 0.5;
	}
	if (currentSlide == "8") {
...
button2.addEventListener("click", (e) => {
	...
	document.querySelector(".button_slide2").style.display = "none";
	document.querySelector(".button_pressed2").style.display = "block";
...
let hidePopup2 = () => {
	...
	document.querySelector(".button_slide2").style.display = "block";
	document.querySelector(".button_pressed2").style.display = "none";
...
button3.addEventListener("click", (e) => {
	...
	document.querySelector(".button_slide3").style.display = "none";
	document.querySelector(".button_pressed3").style.display = "block";
	document.querySelector(".overlay").classList.add("overlay-show");	
});
...
let hidePopup3 = () => {
	...
	document.querySelector(".button_slide3").style.display = "block";
	document.querySelector(".button_pressed3").style.display = "none";
	document.querySelector(".overlay").classList.remove("overlay-show");
}
...
button4.addEventListener("click", (e) => {
	...
	document.querySelector(".button_slide4").style.display = "none";
	document.querySelector(".button_pressed4").style.display = "block";
	document.querySelector(".overlay").classList.add("overlay-show");
});
...
let hidePopup4 = () => {
	...
	document.querySelector(".button_slide4").style.display = "block";
	document.querySelector(".button_pressed4").style.display = "none";
	document.querySelector(".overlay").classList.remove("overlay-show");
}
...
button6.addEventListener("click", (e) => {
	...
	document.querySelector(".button_slide6").style.display = "none";
	document.querySelector(".button_pressed6").style.display = "block";
	document.querySelector(".overlay").classList.add("overlay-show");
});
...
let hidePopup6 = () => {
	...
	document.querySelector(".button_slide6").style.display = "block";
	document.querySelector(".button_pressed6").style.display = "none";
	document.querySelector(".overlay").classList.remove("overlay-show");
}

let openbox = (id) => {
	document.getElementById(id).style.display = "block";
	let old = document.querySelector(`.` + id + `-circle`);
	let show = document.querySelector(`.` + id + `-circle-clicked`);
...
let deletePopups = () => {
	...
	document.querySelector(`.box1-circle`).style.display = "block";
	document.querySelector(`.box1-circle-clicked`).style.display = "none";
	document.querySelector(`.box2-circle`).style.display = "block";
	document.querySelector(`.box2-circle-clicked`).style.display = "none";
	document.querySelector(`.box3-circle`).style.display = "block";
	document.querySelector(`.box3-circle-clicked`).style.display = "none";
	document.querySelector(`.box4-circle`).style.display = "block";
	document.querySelector(`.box4-circle-clicked`).style.display = "none";
}
...
document.querySelector(".button_pressed2").onclick = function () {
	deletePopups();
};
document.querySelector(".button_pressed3").onclick = function () {
	deletePopups();
};
document.querySelector(".button_pressed4").onclick = function () {
	deletePopups();
};
document.querySelector(".button_pressed6").onclick = function () {
	deletePopups();
};
document.querySelector(".arrow-prev").onclick = function () {	
	clickEffect(document.querySelector(".arrow-prev"));
	swiper.slidePrev();
};
document.querySelector(".arrow-next").onclick = function () {
	clickEffect(document.querySelector(".arrow-next"));
	swiper.slideNext();	
};

// эффект нажатия
let clickEffect = function (btn) {
...
// кнопки с этапами
document.querySelector("#stage0").onclick = function () {
	swiper.slideTo(2);
};
document.querySelector("#stage33").onclick = function () {
	swiper.slideTo(3);
};
document.querySelector("#stage34").onclick = function () {
	swiper.slideTo(3);
};
document.querySelector("#stage80").onclick = function () {
	swiper.slideTo(4);
};
document.querySelector("#stage91").onclick = function () {
	swiper.slideTo(6);
};